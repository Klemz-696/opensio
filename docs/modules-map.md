...
| 15 | `serveurs-web-pki-tls` | Services Web, Reverse Proxy & Infrastructure PKI / TLS | **À créer** | 6 | 3 | B2.3, B3.2, B3.3 |
| 16 | `vpn-acces-distants` | Réseaux privés virtuels (VPN) & Accès distants sécurisés | **À créer** | 5 | 2 | B2.1, B2.2, B3.2, B3.3 |
| 17 | `scripting-automatisation` | Scripting système & Automatisation (Bash & PowerShell) | **À créer** | 6 | 2 | B1.1, B2.3 |
| 18 | `cybersecurite-durcissement-audit` | Cybersécurité : Durcissement, Audit & Gestion des vulnérabilités | **À créer** | 6 | 3 | B3.1, B3.2, B3.3, B3.4 |
