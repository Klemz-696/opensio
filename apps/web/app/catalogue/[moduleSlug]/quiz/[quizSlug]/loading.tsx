  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div className="w-3 h-3 bg-slate-200 dark:bg-slate-800 rounded" />
      ...
      <div className="glass-panel rounded-2xl p-8 border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/60 mb-6">
        <div className="flex items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-slate-200 dark:bg-slate-800" />
            <div className="space-y-2">
              <div className="w-48 h-6 bg-slate-200 dark:bg-slate-800 rounded-lg" />
              <div className="w-32 h-3 bg-slate-200/60 dark:bg-slate-800/60 rounded" />
            </div>
          </div>
      ...
      {[1, 2, 3].map((n) => (
        <div
          key={n}
          className="glass-panel rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/60 mb-6 space-y-4"
        >
          ...
          <div className="space-y-2 py-2">
            ...
            <div className="w-1/2 h-4 bg-slate-200/70 dark:bg-slate-800/70 rounded" />
          </div>
          ...
          <div className="space-y-3 pt-2">
            {[1, 2, 3, 4].map((c) => (
              <div
                key={c}
                className="w-full h-12 rounded-xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex items-center px-4 gap-3"
              >
