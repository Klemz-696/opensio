    ...
    >
      ...
      <div className="flex-1 min-w-0 w-full">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          ...
          <div className="h-7 bg-slate-800 rounded-xl w-36" />
        </div>
        ...
        <article className="glass-panel rounded-2xl p-6 sm:p-10 border border-slate-800 mb-8 space-y-6">
        ...
        <div className="flex items-center justify-between p-6 rounded-2xl bg-slate-900/80 border border-slate-800 mb-8">
          <div className="h-5 bg-slate-800 rounded w-32" />
          <div className="h-9 bg-slate-800 rounded-xl w-44" />
        </div>

        {/* Boutons de navigation Précédent / Suivant skeleton */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
          <div className="h-24 rounded-2xl bg-slate-900/80 border border-slate-800 p-4" />
          <div className="h-24 rounded-2xl bg-slate-900/80 border border-slate-800 p-4" />
        </div>
      </div>

      {/* Sommaire latéral skeleton (Desktop) */}
      <aside className="hidden lg:block w-80 shrink-0 h-[calc(100vh-8rem)] sticky top-24 bg-slate-900/80 border border-slate-800 rounded-2xl p-5 space-y-4">
