      ...
      {isLoading ? (
        ...
        <div className="p-6 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-700 dark:text-rose-300 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-rose-800 dark:text-rose-200">Erreur de chargement du catalogue</h3>
            <p className="text-sm mt-1 text-rose-700/90 dark:text-rose-300/90">{error}</p>
            <button
              onClick={() => void loadCatalogue()}
              className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-rose-500/20 hover:bg-rose-500/30 border border-rose-500/40 text-xs font-semibold text-rose-800 dark:text-rose-200 transition-colors cursor-pointer"
            >
        ...
        <div className="p-12 rounded-2xl glass-panel text-center text-slate-600 dark:text-slate-400">
          <p className="text-base font-semibold text-slate-900 dark:text-white">Aucun cours publié pour le moment</p>
