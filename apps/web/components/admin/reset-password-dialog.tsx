          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Utilisateur : <strong className="text-slate-200">{user.displayName}</strong> ({user.email})
              </p>
            </div>
          </div>
          <button
        ...
        {newPasswordResult ? (
          <div className="space-y-5">
            <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-emerald-200">Nouveau mot de passe généré !</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-950/60 border border-slate-700 rounded-xl text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500"
              />
            </div>
