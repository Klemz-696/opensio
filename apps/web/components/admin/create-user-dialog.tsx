        ...
        {createdResult ? (
          <div className="space-y-5">
            <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-emerald-200">Compte créé avec succès !</p>
            ...
            <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3">
              <div className="text-xs text-slate-400">
                Email : <strong className="text-white">{createdResult.user.email}</strong>
              </div>
              <div className="text-xs text-slate-400">
                Nom complet : <strong className="text-white">{createdResult.user.displayName}</strong>
              </div>
              <div className="text-xs text-slate-400">
                Rôle : <strong className="text-white">{createdResult.user.role}</strong>
              </div>
              <div className="pt-2 border-t border-slate-800">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-amber-300 font-mono text-sm select-all focus:outline-none"
                  />
                  <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-950/60 border border-slate-700 rounded-xl text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2 bg-slate-950/60 border border-slate-700 rounded-xl text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
              >
