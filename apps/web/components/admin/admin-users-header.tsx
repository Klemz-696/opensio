    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3.5">
          ...
          <div>
            <div className="text-xs text-slate-400 font-medium">Total Comptes</div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3.5">
          ...
          <div>
            <div className="text-xs text-slate-400 font-medium">Apprenants</div>
            <div className="text-lg font-bold text-white">{learnerCount}</div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3.5">
          ...
          <div>
            ...
            <div className="text-lg font-bold text-white">{adminCount}</div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3.5">
          ...
          <div>
            <div className="text-xs text-slate-400 font-medium">Actifs</div>
