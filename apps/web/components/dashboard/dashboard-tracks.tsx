    ...
    <div className="glass-panel rounded-2xl p-6 border border-slate-800 mb-8">
      <div className="flex items-center justify-between gap-2 mb-4 pb-3 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-white">Progression par Année</h2>
        </div>
        <span className="text-xs text-slate-400">Cursus BTS SIO SISR</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {tracks.map((track) => (
          ...
          >
            ...
            <Link
              href="/catalogue"
              className="inline-flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs font-bold text-slate-200 transition-colors cursor-pointer"
            >
