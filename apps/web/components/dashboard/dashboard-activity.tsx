  ...
  return (
    <div className="glass-panel rounded-2xl p-6 border border-slate-800 mb-8">
      <div className="flex items-center justify-between gap-2 mb-4 pb-3 border-b border-slate-800">
        ...
        <span className="text-xs text-slate-400">Journal en direct</span>
      </div>
      ...
      <div className="space-y-3">
        {events.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className="flex items-start justify-between gap-3 p-3 rounded-xl bg-slate-900/50 border border-slate-800/60"
            >
              <div className="flex items-start gap-3">
                <div className="p-1.5 rounded-lg bg-slate-800 border border-slate-700/80 mt-0.5 shrink-0">
                  {detail.icon}
                </div>
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 mt-0.5">{detail.subtext}</p>
                </div>
              </div>
