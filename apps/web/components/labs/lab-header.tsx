...
export function LabHeader({ lab, session }: LabHeaderProps) {
  ...
  const getStatusBadge = () => {
    if (!session) {
      if (lab.isCompleted) {
        return (
          <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-xs font-bold shadow-sm">
      ...
      return (
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800 text-slate-400 border border-slate-700 text-xs font-medium">
    ...
    switch (session.status) {
      ...
      case 'running':
        return (
          <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-sky-500/15 border border-sky-500/30 text-sky-300 text-xs font-bold animate-pulse shadow-sm">
      ...
      case 'failed':
        return (
          <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-amber-500/15 border border-amber-500/30 text-amber-300 text-xs font-bold shadow-sm">
      ...
      case 'expired':
        return (
          <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-rose-500/15 border border-rose-500/30 text-rose-300 text-xs font-bold shadow-sm">
  ...
  return (
    <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-800 bg-slate-900/80 shadow-2xl mb-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-5 border-t border-slate-800/80">
        <div className="flex flex-col p-3 rounded-xl bg-slate-950/40 border border-slate-800/80">
