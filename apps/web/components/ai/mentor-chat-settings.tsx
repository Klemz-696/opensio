...
export function MentorChatSettings({
  ...
  return (
    <div className="p-4 bg-slate-900/95 border-b border-slate-800 space-y-3 text-xs">
      <div>
      ...
      <div className="pt-2 border-t border-slate-800 flex items-center justify-between">
        <div>
          <span className="font-semibold text-slate-200 block">Mode Libre (Explications directes)</span>
        ...
        <button
          ...
          className={`w-11 h-6 rounded-full p-1 transition-colors cursor-pointer flex items-center ${
            preferences.freeMode ? 'bg-indigo-600 justify-end' : 'bg-slate-800 justify-start'
          }`}
        >
