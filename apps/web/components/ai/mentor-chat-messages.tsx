  ...
  if (messages.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center text-slate-400">
        ...
        <h4 className="font-semibold text-slate-200 text-sm">Mentor OpenSIO</h4>
        ...
        <div className="mt-4 flex items-center gap-1.5 text-[11px] text-emerald-400/90 bg-emerald-950/40 border border-emerald-800/40 px-2.5 py-1 rounded-full">
    ...
    <div className="flex-1 p-4 overflow-y-auto space-y-4">
      {messages.map((msg, idx) => {
        ...
        return (
          ...
          >
            ...
            {isUser && (
              <div className="w-8 h-8 rounded-xl bg-blue-600/20 border border-blue-500/30 flex items-center justify-center text-blue-300 shrink-0 mt-0.5">
      ...
      {isLoading && (
        <div className="flex gap-3 justify-start">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl rounded-bl-none px-4 py-3 text-slate-400 text-xs flex items-center gap-2">
